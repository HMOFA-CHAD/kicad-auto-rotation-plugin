...
I'd like to thank [Alex](https://x.com/averagearc) for help with the hotkeys, and [Brady](https://x.com/BradyRMayes) for the idea of building a plugin like this. I also thank Frank ([Zzoeffie](https://forum.kicad.info/t/how-to-make-a-personal-user-library-install-under-pcm/55589)) on the KiCad forum for the guide on installing custom PCM content. I hope others may find it useful!
